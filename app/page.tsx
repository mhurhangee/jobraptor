  ...
  return (
    <PageContainer>
          ...
          {[
            {
              ...
              color: 'bg-neon-yellow transform -rotate-1 hover:rotate-0 transition-transform',
            },
            {
              icon: TrendingUp,
              ...
              color: 'bg-neon-pink transform rotate-2 hover:rotate-0 transition-transform',
            },
            {
              icon: Shield,
              ...
              color: 'bg-neon-blue transform -rotate-1 hover:rotate-0 transition-transform',
            },
            {
              icon: Users,
              title: 'COMPANY INTEL',
              description: 'Deep dive into company data. Know your enemy before you strike.',
              color: 'bg-neon-teal transform rotate-1 hover:rotate-0 transition-transform',
            },
            {
              icon: Zap,
              ...
              color: 'bg-neon-purple transform -rotate-1 hover:rotate-0 transition-transform',
            },
            {
              icon: Star,
              ...
              color: 'bg-neon-orange transform rotate-1 hover:rotate-0 transition-transform',
            },
          ].map((feature, index) => (
      ...
      */}
      ...
      <section className="py-20 bg-white bg-dots relative">
        <div className="container mx-auto px-4">
