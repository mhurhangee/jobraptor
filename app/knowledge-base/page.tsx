...
export default function KnowledgeBasePage() {
  return (
    <PageContainer>
      {/* Hero Section */}
      <Section layout="center" border="bottom" background="neon-yellow" padding="xl">
        <div className="max-w-4xl">
          ...
          <h1 className="font-heading text-6xl font-bold mb-6 transform rotate-1">
            MASTER THE
            <span className="block text-7xl bg-neon-pink px-4 py-2 transform -rotate-1 inline-block mt-2 neo-brutal-sm">
              HUNT
            </span>
          </h1>
      ...
      {/* Popular Content */}
      <Section layout="center" container="lg" border="top" background="white" pattern="hatch" padding="xl">
        <div className="text-center mb-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white neo-brutal-sm p-6">
            <h3 className="font-heading text-lg font-bold mb-2">📝 Resume Resources</h3>
      ...
      {/* Getting Started */}
      <Section layout="center" container="md" padding="xl">
