              ...
              <div className="flex items-start justify-between">
                <div className="flex-1 space-y-2">
                  <InlineEditable
                    ...
                    className="border-none bg-transparent px-0 text-2xl font-bold hover:bg-gray-50"
                    debounceMs={1500}
                  />
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <button
                ...
                className="rounded-lg border border-gray-200 p-3 text-sm transition-colors hover:bg-gray-50"
              >
              ...
              <button
                ...
                className="rounded-lg border border-gray-200 border-red-200 p-3 text-sm text-red-600 transition-colors hover:bg-gray-50 hover:bg-red-50"
              >
